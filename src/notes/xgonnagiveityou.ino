    ...
    if(untztrument.readSwitches()) { // Button state change?
      for(uint8_t i=0; i<N_BUTTONS; i++) { // For each button...
        ...
        if(untztrument.justPressed(i)) {
          ...
          untztrument.setBrightness(10);
          untztrument.setLED(i);
     untztrument.writeDisplay();
for( int l = 0; l < 8; l++){
              untztrument.setLED(untztrument.xy2i(x-l, y+l));
          untztrument.setLED(untztrument.xy2i(x+l, y+l));
          untztrument.setLED(untztrument.xy2i(x+l, y-l));     
          untztrument.setLED(untztrument.xy2i(x-l, y-l)); 
}
          ...
          for(uint8_t l = 0; l <  N_BUTTONS; l++){
            untztrument.clrLED(l); 
          }
//          untztrument.clrLED(i);                        
//          untztrument.clrLED(untztrument.xy2i(x+1, y));
//          untztrument.clrLED(untztrument.xy2i(x-1, y));
//          untztrument.clrLED(untztrument.xy2i(x, y-1));
//          untztrument.clrLED(untztrument.xy2i(x, y+1));
//          untztrument.clrLED(untztrument.xy2i(x-1, y+1));
//          untztrument.clrLED(untztrument.xy2i(x+1, y+1));
//          untztrument.clrLED(untztrument.xy2i(x+1, y-1));     
//          untztrument.clrLED(untztrument.xy2i(x-1, y-1)); 
//
//           untztrument.clrLED(untztrument.xy2i(x-2, y+2));
//          untztrument.clrLED(untztrument.xy2i(x+2, y+2));
//          untztrument.clrLED(untztrument.xy2i(x+2, y-2));     
//          untztrument.clrLED(untztrument.xy2i(x-2, y-2)); 
//           untztrument.clrLED(untztrument.xy2i(x+2, y));
//          untztrument.clrLED(untztrument.xy2i(x-2, y));
//          untztrument.clrLED(untztrument.xy2i(x, y-2));
//          untztrument.clrLED(untztrument.xy2i(x, y+2));
        }
      }
      untztrument.writeDisplay();
